...
const userContext = React.createContext('shraddha')
...
//in App component import provider and wrape the conponent withing provider Component
...
//bt this type is limited to class only not in functional comp